#ifndef TEAPOTPATCHES_H
#define TEAPOTPATCHES_H

#include "main.h"
#include "MeshBufferObject.h"


static GLfloat teapotPatchVertices[] = {
											1.4f,0.0f,2.4f,
											1.4f,-0.784f,2.4f,
											0.784f,-1.4f,2.4f,
											0.0f,-1.4f,2.4f,
...
static GLuint teapotPatchIndices[] = {
...
class TeapotPatches : public BufferObject
{
public:
	TeapotPatches(GLuint vertexShader);
};
